...
{
    public class WorkplaceLanguageCapacitorReportController : Controller
    {
        private CentACSAssessmentsEntities db = new CentACSAssessmentsEntities();

        // GET: WorkplaceLanguageCapacitorReport
        public async Task<ActionResult> Index()
        {
            return View(await db.tblWorkplace_LanguageCapacitorReport.ToListAsync());
        }

        // GET: WorkplaceLanguageCapacitorReport/Details/5
        public async Task<ActionResult> Details(int? languageKey)
        {
            ...
            tblWorkplace_LanguageCapacitorReport tblWorkplace_LanguageCapacitorReport = await db.tblWorkplace_LanguageCapacitorReport.Where(l => l.LanguageKey == languageKey).FirstAsync();
        ...
        // GET: WorkplaceLanguageCapacitorReport/Create
        public ActionResult Create(Int32 languageKey = 1)
        {
            var model = new tblWorkplace_LanguageCapacitorReport()
            {
        ...
        // POST: WorkplaceLanguageCapacitorReport/Create
        ...
        // GET: WorkplaceLanguageCapacitorReport/Edit/5
        public async Task<ActionResult> Edit(int? languageKey)
        {
            ...
            var results = await db.tblWorkplace_LanguageCapacitorReport.Where(l => l.LanguageKey == languageKey).ToListAsync();
        ...
        // POST: WorkplaceLanguageCapacitorReport/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: WorkplaceLanguageCapacitorReport/Delete/5
        ...
        // POST: WorkplaceLanguageCapacitorReport/Delete/5
